# implementation for the baseline - SADDEN
...
graph = nx.read_gml('./Datasets/real-world_networks/Dol.gml', label = "id")    
...
e_ = graph.get_edgelist()
e2_ = graph2.get_edgelist()
